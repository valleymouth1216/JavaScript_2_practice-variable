...
//   Math.floor( Math.random() * 3 )・・・0～2までのランダムな整数値を生成する　※0スタート
//   関数内の「3」はランダム生成したい整数値の＋1を指定する
//
//   if(js_hand_num == 0){
//     js_hand = "グー";
...
//
//   return js_hand;
//   ランダム生成された数値の戻り値としてグー・チョキ・パーを出しわける
// }


//↓入力されたグー・チョキ・パーと、JavaScriptで生成したランダムなじゃんけんの手を比べ、勝ち・負け・引き分けの結果を表示
